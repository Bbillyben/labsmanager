...
class Nh3Field():
    ...
    def formfield(
        self, form_class: FormField = nh3_forms.Nh3Field, **kwargs: Any
    ) -> FormField:
...
class Nh3Field_CharField(Nh3Field, models.CharField):
    pass

class Nh3Field_TextField(Nh3Field, models.TextField):
    pass
...
function submitFormData(fields, options) {
    ...
    var upload_func = labsmanagerPut;

    if (has_files) {
        upload_func = labsmanagerFormDataUpload;
        data = form_data;
    }
...
function initializeRelatedField(field, fields, options={}) {
    ...
    if (field.value) {
        ...
        labsmanagerGet(url, field.filters || {}, {
            success: function(data) {
        ...
        labsmanagerGet(field.api_url, filters || {}, {
            success: function(data) {
 ...
 * - model: The name of the labsmanager model e.g. 'stockitem'

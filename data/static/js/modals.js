...
function createNewModal(options={}) {
    ...
    $('.labsmanager-modal').each(function() {
    ...
    var html = `
    <div class='modal fade modal-fixed-footer modal-primary labsmanager-modal' role='dialog' id='modal-form-${id}' tabindex='-1'>
        <div class='modal-dialog'>
            <div class='modal-content'>
                ...
                <div class='modal-footer'>
                    ...
                    <button type='button' class='btn btn-secondary' id='modal-form-close' data-bs-dismiss='modal'>Cancel</button>
                    <button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>Submit</button>
                </div>
            </div>
        </div>
    </div>
...
function reloadFieldOptions(fieldName, options) {
    ...
    labsmanagerGet(options.url, options.params, {
...
function showQuestionDialog(title, content, options={}) {
    ...
    var modal = createNewModal({
        title: title,
        submitText: options.accept_text || 'Accept',
        closeText: options.cancel_text || 'Cancel',
    });
    ...
    var ajax_data = {
        ...
        error: function(xhr) {
            ...
            if (xhr.status == 0) {
                ...
                showAlertDialog(
                    'No Response',
                    'No response from the labsmanager server',
                );

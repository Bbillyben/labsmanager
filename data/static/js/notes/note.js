...
(function ($) {
    ...
    function add_note(note, liTarget, noteTarget){
        id = createIdFrom(note.name);
            ...
            if(USER_PERMS.includes("infos.change_genericnote"))tab+="<button class='icon edit btn btn-success' data-app='"+settings.app+"' data-model='"+settings.model+"' data-pk='"+note.pk+"'><i type = 'button' class='fas fa-pen-to-square'></i></button>";
